...
* [Google Search Console](https://search.google.com/search-console/about) | [Bing Webmaster Tools](https://www.bing.com/webmasters/about)
  ...
  * The site uses structured data ( [Schema.org](schema.org) / JSON-LD ) to better interact with search engines, although this does not affect the user experience in any way
...
#### Publications | [/publications.html](https://github.com/psmit703/personal-website/blob/main/publications.html)

This page displays my publications and can be accessed at

    https://psmit.dev/publications.html

Abstracts will always be provided for each publication. Where possible, the page will also provide links to full copies of each publication, although these may link to external websites.
...
Brief descriptions of papers are given along with links to their respective PDFs.
...
#### Sitemap (Text) | [/sitemap.html](https://github.com/psmit703/personal-website/blob/main/sitemap.html)
...
#### Sitemap (XML) | [/sitemap.xml](https://github.com/psmit703/personal-website/blob/main/sitemap.xml)

This page contains an XML sitemap of the site and can be accessed at

    https://www.psmit.dev/sitemap.xml

It contains an XML sitemap. Pages and last-modified dates are updated as necessary.
